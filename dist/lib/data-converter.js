...
class DataConverter {
    ...
    static async createOptionMapping(appToken, tableId) {
        var _a;
        try {
            const api = new lark_api_1.LarkBitableAPI({
            ...
            for (const field of fields) {
                ...
                if (field.type === 3 || field.ui_type === 'SingleSelect' || field.ui_type === 'MultiSelect') {
                    const mapping = {};
                    console.log(`选项字段 ${field.field_name} 的选项:`, (_a = field.property) === null || _a === void 0 ? void 0 : _a.options);
...
DataConverter.strategyOptionMapping = {
    'opteZ8clPp': '指增',
    'optAf8gJwT': '指增',
    'optBf2hKwU': 'CTA',
    'optCg3lLxV': '量选',
